...
if go_kaggle or not os.path.isfile("predictions_rf_fonly.csv"):
    ...
    pred_df.to_csv('predictions_rf_fonly.csv', index=False)
...
if go_kaggle or not os.path.isfile("predictions_xgb_fonly.csv"):
    # This time we train our classifier on the full dataset that it is available to us.
    ...
    pred_df = pd.concat(predictions)
    pred_df.to_csv('predictions_xgb_fonly.csv', index=False)
